...
window.onload = function() {
  ...
  var Languages = {
    ...
    arabic: ['كلمات','حروف','ُحب','ضوء','حياة','جمال','عربية','كلمة','شغف','اقرأ','قلم','قمر','قهوة','روح','سماء','سلام','ورد'],
       english: ['Breath', 'Love', 'Light', 'Soul', 'Beauty', 'Art', 'Life', 'Voice', 'Wordiness', 'Words', 'Letters', 'Shine', 'Books', 'Write'],
      spanish: ['Hoy Brillas', 'Eres Increíble', 'Fuerza única', 'Eres fuerte', 'Triunfo diario', 'Eres luz', 'Eres paz', 'Eres todo', 'Brillas fuerte', 'Supera límites', 'Cosecha éxitos', 'Eleva tus metas', 'Increíblemente hermosa', 'Eres preciosa', 'Eres una joya', 'Tu belleza irradia', 'Resplandece siempre', 'Te quiero ;3']
  }
  ...
  var Heart = {
    configures: {
      ...
      timer: 750, // (milliseconds) Every so often a word will fly
      power: 250, // The power of the flying words (Phyiscal power!)
    ...
    init: function() { 
      ...
      var self = this;
      this.configures.language = Languages.spanish; // Establecer el idioma por defecto como español
